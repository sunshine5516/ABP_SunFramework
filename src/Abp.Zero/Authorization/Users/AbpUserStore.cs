...
namespace Abp.Zero.Authorization.Users
{
        ...
        where TUser : AbpUser<TUser>
    {
        ...
        //private readonly IUserStore<TUser, long> userStore;
        #endregion
        #region 构造函数
        /// <summary>
        /// 构造函数.
        ...
        public virtual async Task<IList<string>> GetRolesAsync(TUser user)
        {
            ...
            //var q=_userRoleRepository.GetAll().Join(_userRepository.GetAll(),)
        ...
        public virtual async Task<bool> IsInRoleAsync(TUser user, string roleName)
        {
            ...
            return await _userRoleRepository.FirstOrDefaultAsync
                (ur => ur.UserId == user.Id && ur.RoleId == role.Id) != null;
        }
        #endregion
        ...
        public virtual async Task<bool> HasPermissionAsync(long userId, PermissionGrantInfo permissionGrant)
        {
            return await _userPermissionSettingRepository.FirstOrDefaultAsync(
                ...
                p.IsGranted == permissionGrant.IsGranted) != null;
        }
